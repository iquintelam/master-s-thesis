...
solutes and TIP3P for water. \cite{doi:10.1021/acs.jctc.5b00963} expanded the Elba force field to calculate solvation free energies in polar (water, hexanol, octanol and nonanol) and apolar (hexane,octane and nonane) solvents, and obtained mean absolute deviations of 1 kcl/mol for water and 1.5 kcal/mol for hexane. In this model, three carbons are represented by a single bead and water is represented by a single bead. 
