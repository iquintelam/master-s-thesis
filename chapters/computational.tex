...
\section{Gibbs Ensemble Monte Carlo (GEMC)}
...
This method has been widely used to calculate phase equilibria, but under performs for the region near the critical point due large density fluctuations. The GEMC also has a poor performance for dense systems like systems with structured phases and at low temperatures since the particle exchange moves has a low acceptance ration for these dense systems.  
