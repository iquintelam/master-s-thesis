...
The Gibbs Ensemble Method \cite{papa1987} is used to study phase coexistence with simultaneous Monte Carlo simulations of two boxes with periodic conditions. The boxes exchange molecules, energy and volume between them, but always maintaining the total volume of the boxes constant. The boxes equilibrium is obtained through MC steps that consist of the translation and rotation moves, volume exchange and randomly exchanges of molecules between the boxes. For the phase equilibrium of only one component, the simulation is carried out at number of particles, temperature and volume constant (NVT). 
