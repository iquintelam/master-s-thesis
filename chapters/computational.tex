...
\begin{table}
	\caption{Coarse-grained geometries.}
	\centering
\begin{tabular}{ccc}
...
\begin{figure}%
	...
	\caption[A set of four subfigures.]{Generalized softcore Mie potential, Eq. \ref{eq:softcore}, for different values of $\lambda$. Here, $\sigma=1$, $\epsilon=1$, $\lambda _{a} = 6$, and $\lambda _{r}$ is equal to
		8 \subref{fig:ex3-a};
		15 \subref{fig:ex3-b};
