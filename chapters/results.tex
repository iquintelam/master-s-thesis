...
The $\lambda s$ and $\eta s$  for the other pairs are available at  Appendix A. It is also important to analyze the reliability of solvation free energy estimations  through the overlapping of the intermediate states. In order to asses the overlap of states, we obtained overlapping matrices with the software alchemical-analysis. The overlapping matrix for the solvation free energy of benzene in hexane is presented in Figure \figref{fig:hexove} and the matrices for the other pairs are available at Appendix B.  
