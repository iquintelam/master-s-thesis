...
\begin{fichacatalografica}
	...
	\fbox{\begin{minipage}[c][10cm]{15cm}		% Largura
	\small
	 \hspace{3.0cm} Matos, Isabela Quintela
	%Sobrenome, Nome do autor
	
	  \hspace{1.0cm} MM433s\hspace{1.0cm}Solvation Free Energy Calculations of Asphaltene 
	  
	  \hspace{3.0cm} -Like Molecules Using The SAFT-$\gamma$ Mie Force Field / 
	  
	  \hspace{3.0cm} \imprimirautor.  - -  \imprimirlocal, \imprimirdata. 
	  	
	  \hspace{3.5cm} \pageref{LastPage} f.\\
	
	  \hspace{3.5cm} Orientador: \imprimirorientador.
	  
	  \hspace{3.5cm} Coorientador: Papa Matar Ndiaye.
	  
	  \hspace{3.5cm} Dissertação (mestrado) - Universidade Federal do 
	  
	  \hspace{3.0cm} Rio de Janeiro, Escola de Química, Programa de Pós
	  
	  \hspace{3.0cm} Graduação em Engenharia de Processos Químicos e
	  
	  \hspace{3.0cm} Bioquímicos, 2018. 
	
	\hspace{3.5cm} 1. Solvation free energy. 2. Asphaltenes. 3. 
	
	\hspace{3.0cm} SAFT-$\gamma$ Mie force field. I. Abreu, Charlles Rubber de 
	
	\hspace{3.0cm} Almeida , orient. II. Ndiaye, Papa Matar , 
	
	\hspace{3.0cm} coorient. III. Título 			
	\end{minipage}}
	\end{center}
\end{fichacatalografica}
% ---
...
%   \assinatura{\textbf{Papa Matar Ndiaye, D.Sc. -EPQB/UFRJ} \\ Co-Supervisor} 
