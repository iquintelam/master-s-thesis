...
%\begin{table*}[h]
%	\centering
%	\caption{Optimized values of $\lambda 's$ and $\eta 's$ for the solute+hexane pairs.}
%	\begin{tabular}{llll}
%		\hline
...
%\begin{table*}[h]
%	\centering
%	\caption{Optimized values of $\lambda 's$ and $\eta 's$ for the solute+1-octanol pairs.}
...
%\begin{table*}[h]
%	\centering
%	\caption{Optimized values of $\lambda 's$ and $\eta 's$ for the toluene+1-octanol pairs.}
%	\begin{tabular}{llllll}
%		\hline
...
%\begin{table*}[h]
%	\centering
%	\caption{Optimized values of $\lambda 's$ and $\eta 's$ for the phenanthrene+$CO_{2}$+1-octanol pairs with different values of $w_{CO_{2}}$.}
...
%\begin{table*}[h]
%	\centering
%	\caption{Optimized values of $\lambda 's$ and $\eta 's$ for the solute+water pairs. }
%	\begin{tabular}{llllllll}
%		\hline
...
\begin{figure}
	\centering
	[a]{{\includegraphics[width=.35\textwidth]{Figures/ohex_pyr} }}%
	\qquad
	[b]{{\includegraphics[width=.35\textwidth]{Figures/ohex_phen} }}%
	\qquad
	[c]{{\includegraphics[width=.35\textwidth]{Figures/ooct_prop} }}%
	\qquad
	[d]{{\includegraphics[width=.35\textwidth]{Figures/ooct_ant} }}%	
	\qquad
	[e]{{\includegraphics[width=.35\textwidth]{Figures/ooct_phen} }}%
	\qquad
	[f]{{\includegraphics[width=.35\textwidth]{Figures/otol_pyr} }}%
	\qquad
	[g]{{\includegraphics[width=.35\textwidth]{Figures/otol_antr} }}%
	\qquad
	[h]{{\includegraphics[width=.35\textwidth]{Figures/otol_phen} }}%		
	\caption{Overlap matrix for hexane+pyrene [a], hexane+phenanthrene [b], 1-octanol+propane [c], 1-octanol+anthracene [d], 1-octanol+phenanthrene [e], toluene+pyrene [f], toluene+anthracene [g], and toluene+phenanthrene [h].}%
	\label{fig:over1}%
\end{figure}
...
\begin{figure}
	\centering
	[a]{{\includegraphics[width=.35\textwidth]{Figures/otolco2_1} }}%
	\qquad
	[b]{{\includegraphics[width=.35\textwidth]{Figures/otolco2_2} }}%
	\qquad
	[c]{{\includegraphics[width=.35\textwidth]{Figures/otolco2_3} }}%
	\qquad
	[d]{{\includegraphics[width=.35\textwidth]{Figures/otolco2_4} }}%	
	\qquad
	[e]{{\includegraphics[width=.35\textwidth]{Figures/owat_prop} }}%
	\qquad
	[e]{{\includegraphics[width=.35\textwidth]{Figures/owat_benz} }}%
	\qquad
	[g]{{\includegraphics[width=.35\textwidth]{Figures/owat_tol} }}%
	\qquad
	[h]{{\includegraphics[width=.35\textwidth]{Figures/owat_phen} }}%		
	\caption{Overlap matrix for toluene+$CO_{2}$(0.087)+phenanthrene [a], toluene+$CO_{2}$(0.119)+phenanthrene [b], toluene+$CO_{2}$(0.169)+phenanthrene [c], toluene+$CO_{2}$(0.289)+phenanthrene [d],  water+propane [e],  water+benzene [f], water+toluene [g], and water+phenanthrene [h].}%
	\label{fig:over1}%
\end{figure}
