...
\begin{figure}
	...
	\caption{Overlap matrix for toluene+$CO_{2}$(0.087)+phenanthrene [a], toluene+$CO_{2}$(0.119)+phenanthrene [b], toluene+$CO_{2}$(0.169)+phenanthrene [c], and toluene+$CO_{2}$(0.289)+phenanthrene [d].}%
	\label{fig:over3}%
\end{figure}
